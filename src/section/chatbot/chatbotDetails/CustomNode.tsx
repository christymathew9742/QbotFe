...
//     },
//   })
// console.log(isFocused,'isFocusedisFocusedisFocusedisFocusedisFocusedisFocusedisFocusedisFocusedisFocusedisFocusedisFocusedisFocusedisFocused')
...
//               className="absolute right-[-25px]! top-1/2 text-xxxs w-2! h-2! bg-node-active! border-2! border-solid! border-op-handil!"
//             />
//           )}
//           <input
//             type="text"
//             className={`px-2 py-0.5 bg-white rounded-l-md w-full text-xxxs focus:outline-none hover:outline-none border border-solid ${
...
//           {opIndex < 1 ? (
//             <button
//               className={`px-2 py-px rounded-r-md bg-blue-500 text-white ${optionsCount >= maxOptions && "!bg-blue-300"}`}
...
//           ) : (
//             <button
//               className="bg-[#fb2c36] text-white px-2 py-px rounded-r-md"
...
//                     >
//                       <Picker data={emojiData} onEmojiSelect={addEmoji} theme="light" searchPosition="none"/>
//                     </div>,
//                   </div>,
//                   document.body
//                 )
...
//               </p>
//               <p
//                 className="text-drag-text absolute text-xxss -right-1 -top-1 text- hover:scale-105 active:scale-95 transition-all duration-200 ease-in-out p-1 cursor-pointer opacity-0"
