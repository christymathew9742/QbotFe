...
import { CheckBox, LoginOutlined } from "@mui/icons-material";
      ...
      {({ isSubmitting }) => (
        <Form>
          <Grid container spacing={2} mb={2} className="w-full">
              <h1 className="w-full text-center text-letter-theme-clr mb-4 text-[clamp(2.2rem,10vw,2.3rem)] font-semibold text-[#6054FF]">
                  Sign In
              </h1>
