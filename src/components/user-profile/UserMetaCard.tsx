...
export default function UserMetaCard() {
  ...
  },[dispatch, pendingUpdates, isUploading]);
            ...
            <div className="flex flex-col items-center w-full gap-6 sm:flex-row">
              <div className="relative group" {...getRootProps()}>
                ...
                { userProfileImage ? (
                  ...
                  <NoProfileIcon width={80} height={80} />
                )}
                <button
                  onClick={open}
              ...
              <Form className="flex flex-col sm:mt-2" >
                ...
                <div className="flex items-center gap-3 px-2 mt-6 lg:justify-end">
                  ...
                  <Button 
                    ...
                    type="submit"
                  >
                    {isUpdate ? <>Seving... <CircularProgress size={20} className="mr-2 !text-white"/></> : <>Save Changes</>}
                  </Button>
                </div>
              </Form>
            )}
