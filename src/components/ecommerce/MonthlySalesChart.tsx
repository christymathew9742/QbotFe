...
export default function MonthlySalesChart({ monthlyAppointments }: MonthlySalesChartProps) {
  // Map JSON data to series and categories
  ...
  const maxCount = Math.max(...seriesData, 10);
